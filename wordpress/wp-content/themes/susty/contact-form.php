    ...
    <div id="primary">
        <main id="main demoPage">
                        ...
                        <?php while (have_posts()) : the_post(); ?>
                            ...
                            <form action="<?php the_permalink(); ?>" id="formContact" method="post">
                                ...
                                <div class="textarea pb-2"><label class="block" for="commentsText">Votre demande*</label>
                                    <textarea name="comments" id="commentsText" rows="20" cols="30" class="requiredField background"><?php if(isset($_POST['comments'])) { if(function_exists('stripslashes')) { echo stripslashes($_POST['comments']); } else { echo $_POST['comments']; } } ?></textarea>
                                    <?php if($commentError != '') { ?>
            ...
            <div class="grid2">
                ...
                <div>
                    <img src="http://0.0.0.0/wp-content/uploads/2021/06/Map_leaflet_Esri_worldGrayCanvas.png" alt=""></div>
                <div>
                </div>
            </div>
        </main><!-- #main -->
