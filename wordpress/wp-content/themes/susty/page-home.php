...
?>
    ...
    <div id="primary">
        <main id="main homepage">
            ...
            <div class="content">
                <img class="text-center wdt-100" src="/wp-content/uploads/2021/06/1024x512px_Votre_empreinte_carbone_va_en_prendre_un_coup.png" alt="toovalu-votre-empreinte-carbone-va-en-prendre-en-compte" aria-label="claims-presentation-toovalu">
            </div>
            <div class="content">
                            ...
                            <ul class="slides">
                                ...
                                <li class="slide-container" id="dynamique">
                                    <div class="slide-image">
                                        <img src="/wp-content/uploads/2021/06/image-4.png" alt="logiciel-impact-analyse" aria-label="logiciel-impact-analyse">
                                    </div>
                                ...
                                <li class="slide-container" id="collecte">
                                    <div class="slide-image">
                                        <img src="/wp-content/uploads/2021/06/image-3.png" alt="impact-logiciel-collect" aria-label="impact-logiciel-collect">
                                    </div>
                                    <div class="carousel-controls">
                                ...
                                <li class="slide-container" id="analyse">
                                    <div class="slide-image">
                                        <img src="/wp-content/uploads/2021/06/image-6-2.png" alt="toovalu-impact-logiciel-analyse-diagramme" aria-label="toovalu-impact-logiciel-analyse-diagramme">
                                    </div>
                                    <div class="carousel-controls">
            ...
            <div class="grid2 pb-2">
                ...
                <div>
                    ...
                    <div class="grid4">
                        ...
                        <div class="text-center">
                            <p>Mettre en oeuvre</p><img src="/wp-content/uploads/2021/06/Groupe-89.png" alt="toovalu-reportage-velo" aria-label="toovalu-reportage-velo">
                        </div>
                        <div class="text-center">
                            <p>Communiquer</p><img src="/wp-content/uploads/2021/06/Groupe-95.png" alt="toovalu-marie-gaborit" aria-label="toovalu-marie-gaborit">
                        </div>
                        <div class="text-center">
                            <p>Engager</p><img src="/wp-content/uploads/2021/06/Groupe-98.png" alt="toovalu-equipe-velo" aria-label="toovalu-equipe-velo">
                        </div>
                    </div>
                </div>
            </div>
            <div class="grid4">
                ...
                <div  class="grid_fullcell">
                    <img src="/wp-content/uploads/2021/06/HP_TT_BC-scaled.jpg" alt="toovalu-seminaire" aria-label="toovalu-seminaire">
                </div>
                <div class="bg-pink">
                ...
                <div class="grid_fullcell">
                    <img src="/wp-content/uploads/2021/06/HP_TT_Trajectoire.jpg" alt="toovalu-reportage-velo" aria-label="toovalu-reportage-velo">
                </div>
                <div class="grid_fullcell">
                    <img src="/wp-content/uploads/2021/06/HP_TT_Piloter-copie-retouch.jpg" alt="toovalu-marie-gaborit" aria-label="toovalu-marie-gaborit">
                </div>
                <div class="bg-yellow">
                ...
                <div class="grid_fullcell">
                    <img src="/wp-content/uploads/2021/06/HP_TT_Construction.jpg"  alt="toovalu-equipe-velo" aria-label="toovalu-equipe-velo">
                </div>
                <div class="bg-green">
            ...
            <hr>
                <div class="testimonial">
                    ...
                    <ul class="slides">
                        ...
                        <li class="slide">
                            <p><q>L’outil TOOVALU transforme la contrainte DPEF en véritable opportunité de pilotage. Avec Toovalu, nous sommes passés d’une collecte d’indicateurs centralisée à un pilotage orienté métier.
